...
<section class="vf9-hero" id="tong-quan">
  <img src="<?php echo esc_url($uploads_url . '/nerio_Nerio-Green-ngoai-that-2-1536x864-1.jpg'); ?>" 
       alt="VinFast Nerio Green Banner" 
       class="vf9-hero-bg"
  ...
  <div class="vf9-hero-content" data-aos="fade-up">
    ...
    <p class="vf9-hero-desc">Nerio Green là mẫu C-SUV điện chở khách dịch vụ chuyên nghiệp phát triển trên nền VFe34, sở hữu khoang cabin êm ái, trợ lý AI thông minh cùng giải pháp chi phí vận hành siêu tiết kiệm.</p>
...
<section class="vf9-configurator" id="configurator">
  <div class="container">
    ...
    <div class="vf9-stage-wrap">
      <img id="nerioCarStageImg" 
           src="<?php echo esc_url($uploads_url . '/cutout_nerio.png'); ?>" 
           alt="VinFast Nerio Green Studio Render" 
    ...
    <div class="vf9-controls-panel" data-aos="fade-up">
      <div class="vf9-controls-grid">
        ...
        <div>
          ...
          <div class="vf9-color-dots-row">
            <button class="vf9-color-dot active" style="background: #10b981;" data-img="<?php echo esc_url($uploads_url . '/cutout_nerio.png'); ?>" data-color="Xanh Green Taxi"></button>
            <button class="vf9-color-dot" style="background: #f59e0b;" data-img="<?php echo esc_url($uploads_url . '/Nerio-Green-mau-vang-540x282-1.png'); ?>" data-color="Vàng Taxi Yellow"></button>
            <button class="vf9-color-dot" style="background: #0f172a;" data-img="<?php echo esc_url($uploads_url . '/Nerio-Green-mau-den-540x282-1.png'); ?>" data-color="Đen Jet Black"></button>
          </div>
        ...
        <div>
          ...
          <div class="vf9-toggle-group" style="margin-bottom: 16px;">
            <button class="vf9-toggle-btn active" onclick="setNerioVersion('taxi', this)">Nerio Green Chạy Dịch Vụ</button>
          </div>

          <div class="vf9-option-group-title">Hình thức sở hữu Pin:</div>
          <div class="vf9-toggle-group">
            <button class="vf9-toggle-btn active" onclick="setNerioBattery('thue', this)">Thuê Pin Ưu Đãi Dịch Vụ</button>
      ...
      <div class="vf9-config-price-bar">
        ...
        <div style="display: flex; gap: 12px;">
          ...
          <button class="vf-btn vf-btn-primary" onclick="alert('Đã gửi yêu cầu tư vấn xe Nerio Green!')">ĐẶT MUA XE DỊCH Vụ</button>
        </div>
      </div>
...
<section class="vf9-section vf9-section-alt" id="tinh-nang">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Chiều dài cơ sở 2.611 mm tối ưu khoảng để chân, đi kèm tính năng trợ lý ảo tiếng Việt ViVi tương tác thông minh.</p>
    </div>

    <div class="vf9-grid-3">
      <div class="vf9-card" data-aos="fade-up">
        <img src="<?php echo esc_url($uploads_url . '/nerio_ae9b5c63-nerio-green-4.jpg'); ?>" 
             alt="Nerio Green vận hành" 
             class="vf9-card-img">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Màn Hình Giải Trí 10 Inch Verticle</h3>
          <p class="vf9-card-desc">Màn hình đặt dọc kết nối Apple CarPlay & Android Auto mượt mượt cho tài xế điều hướng chuyến đi.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="100">
        <img src="<?php echo esc_url($uploads_url . '/gallery_nerio.webp'); ?>" 
             alt="Ngoại thất Nerio Green" 
             class="vf9-card-img">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Thiết Kế Crossover Khỏe Khoắn</h3>
          <p class="vf9-card-desc">Cụm đèn pha LED đặt thấp và dải đèn nhận diện cánh chim tạo dấu ấn hiện đại khi đón khách đêm.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="200">
        <img src="<?php echo esc_url($uploads_url . '/charging_station_vgreen.jpg'); ?>" 
             alt="Trạm sạc V-GREEN" 
             class="vf9-card-img">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Sạc Siêu Nhanh 18 Phút</h3>
          <p class="vf9-card-desc">Sạc cực nhanh 18 phút đi được thêm 180 km tại hệ thống trụ sạc V-GREEN rộng khắp Việt Nam.</p>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="vf-calc-left">
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="lít">
              <input type="number" id="nerio_fuel_consumption" class="vf-number-input" value="8" min="1" max="30" step="0.1" placeholder="8">
            </div>
          </div>
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="km">
              <input type="number" id="nerio_distance_month" class="vf-number-input" value="3500" min="100" max="10000" step="50" placeholder="3500">
            </div>
          </div>

          <p class="vf-hint">(*) Nhập số, dùng dấu chấm "." cho phần thập phân (không dùng dấu phân cách hàng nghìn). Ví dụ: 8 lít; 3500 km chạy taxi.</p>
        ...
        <div class="vf-calc-right">
          <div class="vf-result-header">
            ...
            <div class="vf-result-header-text">
              ...
              <p class="vf-result-placeholder" id="nerio_result_placeholder">(*) Chưa có dữ liệu so sánh. Vui lòng nhập thông tin!</p>
            </div>
            <img src="<?php echo esc_url($uploads_url . '/cutout_nerio.png'); ?>"
                 alt="VinFast Nerio Green"
  ...
  <div class="container">
    ...
    <div class="vf9-specs-table-wrap" data-aos="fade-up">
      <table class="vf9-specs-table">
        <tr><td>Dài x Rộng x Cao (mm)</td><td>4.300 x 1.793 x 1.613</td></tr>
        <tr><td>Chiều dài cơ sở (mm)</td><td>2.611 mm</td></tr>
        <tr><td>Số chỗ ngồi</td><td>5 chỗ</td></tr>
        <tr><td>Động cơ điện</td><td>1 Motor FWD (Dẫn động cầu trước)</td></tr>
        <tr><td>Công suất tối đa</td><td>147 mã lực (110 kW)</td></tr>
        <tr><td>Dung lượng pin khả dụng</td><td>42.0 kWh</td></tr>
        <tr><td>Quãng đường di chuyển (NEDC)</td><td>318 km / 1 lần sạc đầy</td></tr>
        <tr><td>Thời gian sạc nhanh (10-70%)</td><td>18 phút sạc nhanh nạp 180km</td></tr>
      </table>
    </div>
