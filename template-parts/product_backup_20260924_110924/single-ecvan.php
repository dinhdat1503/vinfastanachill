...
<section class="vf9-hero" id="tong-quan">
  <img src="<?php echo esc_url($uploads_url . '/ecvan_banner-scaled.webp'); ?>" 
       alt="VinFast EC Van Banner" 
       class="vf9-hero-bg"
  ...
  <div class="vf9-hero-content" data-aos="fade-up">
    ...
    <p class="vf9-hero-desc">VinFast EC Van là dòng xe tải nhẹ điện 2 chỗ chở hàng đô thị tiên phong tại Việt Nam, sở hữu khoang chứa rộng tới 2.500 lít, tải trọng lớn và chi phí sạc điện siêu rẻ giúp tối đa hóa lợi nhuận.</p>
...
<section class="vf9-configurator" id="configurator">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Tùy chọn màu sắc ngoại thất chính hãng và hình thức sở hữu pin cho doanh nghiệp vận tải</p>
    </div>

    <!-- Canvas Xe Studio EC Van -->
    <div class="vf9-stage-wrap">
      <img id="ecvanCarStageImg" 
           src="<?php echo esc_url($uploads_url . '/cutout_ecvan.webp'); ?>" 
           alt="VinFast EC Van Studio Render" 
    ...
    <div class="vf9-controls-panel" data-aos="fade-up">
      <div class="vf9-controls-grid">
        ...
        <div>
          ...
          <div class="vf9-color-dots-row">
            <button class="vf9-color-dot active" style="background: #ffffff;" data-img="<?php echo esc_url($uploads_url . '/ecvan-white-scaled.webp'); ?>" data-color="Trắng Brahmini White"></button>
            <button class="vf9-color-dot" style="background: #f59e0b;" data-img="<?php echo esc_url($uploads_url . '/ecvan-yellow-scaled.webp'); ?>" data-color="Vàng Sunset Yellow"></button>
            <button class="vf9-color-dot" style="background: #10b981;" data-img="<?php echo esc_url($uploads_url . '/ecvan-jade-scaled.webp'); ?>" data-color="Xanh Ngọc Jade Green"></button>
            <button class="vf9-color-dot" style="background: #dc2626;" data-img="<?php echo esc_url($uploads_url . '/ecvan-red-scaled.webp'); ?>" data-color="Đỏ Crimson Red"></button>
          </div>
      ...
      <div class="vf9-config-price-bar">
        ...
        <div style="display: flex; gap: 12px;">
          ...
          <button class="vf-btn vf-btn-primary" onclick="alert('Đã gửi yêu cầu tư vấn mua xe VinFast EC Van!')">ĐẶT MUA NGAY</button>
        </div>
      </div>
...
<section class="vf9-section vf9-section-alt" id="thung-hang">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Sàn thùng phẳng lót kim loại chống trượt, cửa lùa hông và cửa sau mở rộng giúp xếp dỡ hàng hóa cực kỳ nhanh chóng.</p>
    </div>

    <div class="vf9-grid-3">
      <div class="vf9-card" data-aos="fade-up">
        <img src="<?php echo esc_url($uploads_url . '/gallery_ecvan.webp'); ?>" 
             alt="Khoang thùng EC Van" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_ecvan.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Dung Tích Thùng 2.5m³</h3>
          <p class="vf9-card-desc">Thùng hàng tối ưu thể tích chứa 2.500 lít, tải trọng cho phép chở lên tới 500 kg hàng hóa.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="100">
        <img src="<?php echo esc_url($uploads_url . '/ecvan_ecvan-yellow-02.webp'); ?>" 
             alt="Cửa lùa hông EC Van" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_ecvan.webp'); ?>'">
        <div class="vf9-card-body">
      ...
      <div class="vf9-card" data-aos="fade-up" data-aos-delay="200">
        <img src="<?php echo esc_url($uploads_url . '/ecvan_ecvan-yellow-03.webp'); ?>" 
             alt="Vách ngăn cách khoang lái EC Van" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_ecvan.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Vách Ngăn Cách An Toàn Khép Kín</h3>
          <p class="vf9-card-desc">Trang bị vách ngăn lồng thép bảo vệ cabin người lái hoàn toàn khỏi va xô từ hàng hóa phía sau.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="vf9-section" id="van-hanh">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Động cơ điện cầu sau RWD khỏe khoắn leo dốc tải nặng mượt mượt, chi phí nhiên liệu siêu rẻ tiết kiệm hàng triệu đồng mỗi tháng.</p>
    </div>
        ...
        <div class="vf-calc-left">
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="lít">
              <input type="number" id="ecvan_fuel_consumption" class="vf-number-input" value="9" min="1" max="30" step="0.1" placeholder="9">
            </div>
          </div>
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="km">
              <input type="number" id="ecvan_distance_month" class="vf-number-input" value="2000" min="100" max="10000" step="50" placeholder="2000">
            </div>
          </div>

          <p class="vf-hint">(*) Nhập số, dùng dấu chấm "." cho phần thập phân (không dùng dấu phân cách hàng nghìn). Ví dụ: 9 lít; 2000 km.</p>
        ...
        <div class="vf-calc-right">
          <div class="vf-result-header">
            ...
            <div class="vf-result-header-text">
              ...
              <p class="vf-result-placeholder" id="ecvan_result_placeholder">(*) Chưa có dữ liệu so sánh. Vui lòng nhập thông tin!</p>
            </div>
            <img src="<?php echo esc_url($uploads_url . '/cutout_ecvan.webp'); ?>"
                 alt="VinFast EC Van"
  ...
  <div class="container">
    ...
    <div class="vf9-specs-table-wrap" data-aos="fade-up">
      <table class="vf9-specs-table">
        <tr><td>Loại xe</td><td>Xe tải nhẹ điện chở hàng (Van 2 chỗ)</td></tr>
        <tr><td>Dài x Rộng x Cao (mm)</td><td>3.190 x 1.679 x 1.622</td></tr>
        <tr><td>Thể tích thùng chứa hàng</td><td>2.500 lít (2.5 m³)</td></tr>
        <tr><td>Tải trọng hàng hóa cho phép</td><td>500 kg</td></tr>
        <tr><td>Động cơ điện</td><td>1 Motor RWD (Dẫn động cầu sau)</td></tr>
        <tr><td>Dung lượng pin khả dụng</td><td>18.64 kWh</td></tr>
        <tr><td>Quãng đường di chuyển</td><td>210 km / 1 lần sạc đầy</td></tr>
