...
<section class="vf9-hero" id="tong-quan">
  <img src="<?php echo esc_url($uploads_url . '/vf7_41_vf7-hero-car.webp'); ?>" 
       alt="VinFast VF 7 Banner" 
       class="vf9-hero-bg"
  ...
  <div class="vf9-hero-content" data-aos="fade-up">
    ...
    <p class="vf9-hero-desc">VinFast VF 7 — Tuyệt tác C-SUV sở hữu thiết kế "Vũ trụ phi thuyền" đầy mê hoặc, động cơ điện 2 cầu AWD công suất 349 mã lực và công nghệ trợ lái ADAS cấp độ 2 tiên tiến.</p>
...
<section class="vf9-configurator" id="configurator">
  <div class="container">
    ...
    <div class="vf9-stage-wrap">
      <img id="vf7CarStageImg" 
           src="<?php echo esc_url($uploads_url . '/cutout_vf7.png'); ?>" 
           alt="VinFast VF 7 Studio Render" 
    ...
    <div class="vf9-controls-panel" data-aos="fade-up">
      <div class="vf9-controls-grid">
        ...
        <div>
          ...
          <div class="vf9-color-dots-row">
            <button class="vf9-color-dot active" style="background: #ffffff;" data-img="<?php echo esc_url($uploads_url . '/cutout_vf7.png'); ?>" data-color="Trắng Brahmini White"></button>
            <button class="vf9-color-dot" style="background: #94a3b8;" data-img="<?php echo esc_url($uploads_url . '/vf7_60_vf7-masterpiece-1.webp'); ?>" data-color="Bạc DeSat Silver"></button>
            <button class="vf9-color-dot" style="background: #8b0000;" data-img="<?php echo esc_url($uploads_url . '/vf7_61_vf7-masterpiece-2.webp'); ?>" data-color="Đỏ Crimson Red"></button>
            <button class="vf9-color-dot" style="background: #1e3a8a;" data-img="<?php echo esc_url($uploads_url . '/vf7_62_vf7-masterpiece-3.webp'); ?>" data-color="Xanh Deep Ocean"></button>
            <button class="vf9-color-dot" style="background: #0f172a;" data-img="<?php echo esc_url($uploads_url . '/vf7_63_vf7-masterpiece-4.webp'); ?>" data-color="Đen Jet Black"></button>
          </div>
          <div class="vf9-selected-color-label" id="vf7ColorLabel">Màu đang chọn: Trắng Brahmini White</div>
        </div>
      ...
      <div class="vf9-config-price-bar">
        <div>
          ...
          <div style="font-size: 12px; color: #64748B;">*Miễn 100% lệ phí trước bạ, tặng quà tặng sạc pin chính hãng VinFast</div>
        </div>
        <div style="display: flex; gap: 12px;">
          <a href="<?php echo esc_url(home_url('/du-toan-tra-gop/')); ?>" class="vf-btn vf-btn-outline">DỰ TOÁN CHI PHÍ</a>
          <button class="vf-btn vf-btn-primary" onclick="alert('Đã gửi yêu cầu tư vấn đặt cọc VinFast VF 7!')">ĐẶT CỌC ONLINE</button>
        </div>
      </div>
...
<section class="vf9-section vf9-section-alt" id="ngoai-that">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Đường nét góc cạnh mui xe vuốt dốc phong cách Coupe, tay nắm cửa ẩn phẳng thân xe và cụm đèn cánh chim ấn tượng.</p>
    </div>

    <div class="vf9-grid-3">
      <div class="vf9-card" data-aos="fade-up">
        <img src="<?php echo esc_url($uploads_url . '/vf7_43_vf7-uu-diem-1.webp'); ?>" 
             alt="Cụm đèn LED VF 7" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_vf7.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Dải LED Cánh Chim Độc Bản</h3>
          <p class="vf9-card-desc">Cụm đèn nhận diện hình cánh chim VinFast sắc sảo kết hợp projector LED hiệu suất cao.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="100">
        <img src="<?php echo esc_url($uploads_url . '/vf7_44_vf7-uu-diem-3.webp'); ?>" 
             alt="Mâm 20 inch VF 7 Plus" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_vf7.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Bộ Mâm Hợp Kim 20 Inch Hầm Hố</h3>
          <p class="vf9-card-desc">Thiết kế mâm phay hai màu thể thao 20 inch khẳng định nét cá tính mạnh mẽ cho bản Plus.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="200">
        <img src="<?php echo esc_url($uploads_url . '/vf7_47_vf7-uu-diem-6.webp'); ?>" 
             alt="Tay nắm cửa ẩn VF 7" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_vf7.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Tay Nắm Cửa Ẩn Ẩn Thân Xe</h3>
          <p class="vf9-card-desc">Tay nắm cửa thụt thò tự động tối ưu hệ số lực cản không khí và gia tăng vẻ tinh tế hiện đại.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="vf9-section" id="noi-that">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Màn hình cảm ứng trung tâm 12.9-inch quay nhẹ hướng về người lái, không gian rộng rãi nhờ chiều dài cơ sở 2.840 mm.</p>
    </div>

    <!-- Interior Hero Photo -->
    <div class="vf9-interior-hero" data-aos="fade-up">
      <img src="<?php echo esc_url($uploads_url . '/vf7_65_vf7-noi-that-overview.webp'); ?>" 
           alt="Nội thất khoang lái VinFast VF 7" 
      ...
      <div class="vf9-interior-overlay">
        <div>
          ...
          <p style="max-width: 640px;">Cửa sổ trời kính cường lực chống tia UV mang lại khoang cabin thoáng đãng cùng dàn âm thanh 8 loa sống động.</p>
        </div>
      </div>
    </div>
    ...
    <div class="vf9-grid-3" style="margin-top: 36px;">
      <div class="vf9-card" data-aos="fade-up">
        <img src="<?php echo esc_url($uploads_url . '/vf7_66_vf7-passion.webp'); ?>" 
             alt="Màn hình 12.9 inch VF 7" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_vf7.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Màn Hình Giải Trí 12.9 Inch</h3>
          <p class="vf9-card-desc">Giao diện tùy biến cao, tích hợp hiển thị góc nhìn 360 độ và trợ lý giọng nói thông minh ViVi.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="100">
        <img src="<?php echo esc_url($uploads_url . '/vf7_68_vf7-cam-ket-tien-ich.webp'); ?>" 
             alt="Ghế thể thao VF 7" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_vf7.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Ghế Thể Thao Bọc Da 2 Tông Màu</h3>
          <p class="vf9-card-desc">Ghế lái chỉnh điện 8 hướng nhớ vị trí, tích hợp làm mát ghế nâng niu mọi chuyến đi xa.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="200">
        <img src="<?php echo esc_url($uploads_url . '/vf7_58_vf7-slide-in-croped.webp'); ?>" 
             alt="Hiển thị HUD kính lái VF 7" 
             class="vf9-card-img"
             onerror="this.src='<?php echo esc_url($uploads_url . '/official_vf7.webp'); ?>'">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Màn Hình Hiển Thị HUD Kính Lái</h3>
          <p class="vf9-card-desc">Chiếu trực tiếp tốc độ, biển báo và cảnh báo lái xe lên kính chắn gió giúp tập trung tối đa.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="vf9-section vf9-section-alt" id="van-hanh">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Hệ dẫn động 2 cầu AWD với 2 mô-tơ điện sản sinh mô-men xoắn cực đại 500 Nm bứt tốc dính lưng ghế.</p>
    </div>
    ...
    <div class="vf9-grid-3" style="margin-top: 48px;">
      <div class="vf9-card" data-aos="fade-up">
        <img src="<?php echo esc_url($uploads_url . '/vf7_69_vf7-lead-banner.webp'); ?>" 
             alt="Trạm sạc V-GREEN VF 7" 
             class="vf9-card-img">
        <div class="vf9-card-body">
      ...
      <div class="vf9-card" data-aos="fade-up" data-aos-delay="100">
        <img src="<?php echo esc_url($uploads_url . '/charging_station_car.jpg'); ?>" 
             alt="Hệ dẫn động AWD VF 7" 
             class="vf9-card-img">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Hệ Dẫn Động 2 Cầu AWD</h3>
          <p class="vf9-card-desc">Phân bổ lực kéo thông minh linh hoạt giữa cầu trước và cầu sau tối ưu độ bám đường khi vào cua.</p>
        </div>
      </div>

      <div class="vf9-card" data-aos="fade-up" data-aos-delay="200">
        <img src="<?php echo esc_url($uploads_url . '/quang-duong.jpg'); ?>" 
             alt="Tiết kiệm chi phí VF 7" 
             class="vf9-card-img">
        <div class="vf9-card-body">
          <h3 class="vf9-card-title">Chi Phí Nhiên Liệu Tối Ưu</h3>
          <p class="vf9-card-desc">Mức tiêu hao năng lượng tối ưu, tiết kiệm hơn 75% chi phí vận hành so với SUV xăng 2.0L Turbo.</p>
        </div>
      </div>
    </div>
...
<section class="vf9-section" id="an-toan">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Đạt tiêu chuẩn an toàn EURO NCAP & ASEAN NCAP 5 sao với đầy đủ các tính năng thông minh nhất.</p>
    </div>
    ...
    <div class="vf9-tech-grid" data-aos="fade-up">
      <div class="vf9-tech-item">
        ...
        <div>
          ...
          <p style="font-size: 14px; color: #64748B;">Tự động điều chỉnh tốc độ duy trì khoảng cách an toàn với xe phía trước trên đường cao tốc.</p>
        </div>
      </div>
      ...
      <div class="vf9-tech-item">
        ...
        <div>
          ...
          <p style="font-size: 14px; color: #64748B;">Xe tự động thực hiện thao tác chuyển làn an toàn khi người lái gạt xi-nhan báo hiệu.</p>
        </div>
      </div>
      ...
      <div class="vf9-tech-item">
        ...
        <div>
          ...
          <p style="font-size: 14px; color: #64748B;">Hệ thống phát hiện va chạm sớm trước/sau và hỗ trợ phanh khẩn cấp phòng tránh tại nạn.</p>
        </div>
      </div>
      ...
      <div class="vf9-tech-item">
        ...
        <div>
          ...
          <p style="font-size: 14px; color: #64748B;">Mô phỏng hình ảnh 3D xung quanh xe sắc nét giúp lùi đỗ vào chỗ hẹp vô cùng dễ dàng.</p>
        </div>
      </div>
    </div>
    ...
    <div class="vf9-privilege-banner" data-aos="fade-up">
      <div>
        <span style="font-size: 12px; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #60a5fa;">Đặc quyền sở hữu VinFast VF 7</span>
        <h3 style="font-size: 2.2rem; font-weight: 900; margin-top: 8px;">Bảo Hành Chính Hãng 10 Năm</h3>
        <p style="color: rgba(255,255,255,0.8); margin-top: 12px; font-size: 15px;">VinFast VF 7 được bảo hành 10 năm hoặc 200.000 km cho xe và Pin, đi kèm dịch vụ cứu hộ 24/7 hoàn toàn miễn phí.</p>
      </div>
      <div>
        ...
        <div class="vf-calc-left">
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="lít">
              <input type="number" id="vf7_fuel_consumption" class="vf-number-input" value="9.5" min="1" max="30" step="0.1" placeholder="9.5">
            </div>
          </div>
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="km">
              <input type="number" id="vf7_distance_month" class="vf-number-input" value="1500" min="100" max="10000" step="50" placeholder="1500">
            </div>
          </div>

          <p class="vf-hint">(*) Nhập số, dùng dấu chấm "." cho phần thập phân (không dùng dấu phân cách hàng nghìn). Ví dụ: 9.5 lít; 1500 km.</p>
        ...
        <div class="vf-calc-right">
          <div class="vf-result-header">
            ...
            <div class="vf-result-header-text">
              ...
              <p class="vf-result-placeholder" id="vf7_result_placeholder">(*) Chưa có dữ liệu so sánh. Vui lòng nhập thông tin!</p>
            </div>
            <img src="<?php echo esc_url($uploads_url . '/cutout_vf7.png'); ?>"
                 alt="VinFast VF 7"
...
<section class="vf9-section vf9-section-alt" id="thong-so">
  <div class="container">
    ...
    <div class="vf9-specs-tabs-nav">
      <button class="vf9-spec-tab-btn active" onclick="switchVF7SpecTab('kich-thuoc', this)">Kích Thước & Động Cơ</button>
    ...
    <div class="vf9-specs-table-wrap" data-aos="fade-up">
      <table class="vf9-specs-table" id="vf7SpecTabKichThuoc">
        <tr><td>Dài x Rộng x Cao (mm)</td><td>4.545 x 1.890 x 1.635</td></tr>
        <tr><td>Chiều dài cơ sở (mm)</td><td>2.840 mm</td></tr>
        <tr><td>Khoảng sáng gầm xe (mm)</td><td>190 mm</td></tr>
        <tr><td>Số chỗ ngồi</td><td>5 chỗ thể thao</td></tr>
        <tr><td>Động cơ điện</td><td>1 Motor (Base FWD) / 2 Motor (Plus AWD)</td></tr>
        <tr><td>Công suất tối đa</td><td>174 HP (Base) / 349 HP (Plus)</td></tr>
        <tr><td>Mô-men xoắn cực đại</td><td>250 Nm (Base) / 500 Nm (Plus)</td></tr>
      </table>

      <table class="vf9-specs-table" id="vf7SpecTabPinSac" style="display: none;">
        <tr><td>Dung lượng pin khả dụng</td><td>75.3 kWh (Lithium LFP)</td></tr>
        <tr><td>Quãng đường di chuyển (WLTP)</td><td>375 km (Base) / 431 km (Plus)</td></tr>
        <tr><td>Thời gian sạc nhanh (10-70%)</td><td>~ 24 phút (Trạm sạc nhanh DC)</td></tr>
      ...
      <table class="vf9-specs-table" id="vf7SpecTabAnToan" style="display: none;">
        <tr><td>Tiêu chuẩn an toàn</td><td>5 sao ASEAN NCAP & EURO NCAP</td></tr>
        <tr><td>Số túi khí</td><td>8 túi khí an toàn</td></tr>
        <tr><td>Hệ thống trợ lái nâng cao ADAS</td><td>Cấp độ 2 (Hỗ trợ chuyển làn, ACC, Cảnh báo va chạm...)</td></tr>
        <tr><td>Hiển thị HUD kính lái</td><td>Có (Bản Plus)</td></tr>
