...
<section class="vf9-hero" id="tong-quan">
  <img src="<?php echo esc_url($uploads_url . '/herio_herio-green-16032025-10-scaled-1.jpg'); ?>" 
       alt="VinFast Herio Green Banner" 
       class="vf9-hero-bg"
  ...
  <div class="vf9-hero-content" data-aos="fade-up">
    ...
    <p class="vf9-hero-desc">Herio Green là mẫu A-SUV điện dịch vụ thế hệ mới được tối ưu dựa trên nền VF 5, sở hữu không gian khoang khách rộng rãi, trang bị an toàn vượt phân khúc và khả năng sinh lời vượt trội.</p>
...
<section class="vf9-configurator" id="configurator">
  <div class="container">
    ...
    <div class="vf9-stage-wrap">
      <img id="herioCarStageImg" 
           src="<?php echo esc_url($uploads_url . '/cutout_herio.png'); ?>" 
           alt="VinFast Herio Green Studio Render" 
    ...
    <div class="vf9-controls-panel" data-aos="fade-up">
      <div class="vf9-controls-grid">
        ...
        <div>
          ...
          <div class="vf9-color-dots-row">
            <button class="vf9-color-dot active" style="background: #10b981;" data-img="<?php echo esc_url($uploads_url . '/cutout_herio.png'); ?>" data-color="Xanh Green Taxi"></button>
            <button class="vf9-color-dot" style="background: #f59e0b;" data-img="<?php echo esc_url($uploads_url . '/Herio-Green-mau-vang-540x282-1.png'); ?>" data-color="Vàng Taxi Yellow"></button>
            <button class="vf9-color-dot" style="background: #94a3b8;" data-img="<?php echo esc_url($uploads_url . '/Herio-Green-mau-bac-540x282-1.png'); ?>" data-color="Bạc DeSat Silver"></button>
            <button class="vf9-color-dot" style="background: #0f172a;" data-img="<?php echo esc_url($uploads_url . '/Herio-Green-mau-den-540x282-1.png'); ?>" data-color="Đen Jet Black"></button>
            <button class="vf9-color-dot" style="background: #dc2626;" data-img="<?php echo esc_url($uploads_url . '/Herio-Green-mau-do-540x282-1.png'); ?>" data-color="Đỏ Crimson Red"></button>
          </div>
        ...
        <div>
          ...
          <div class="vf9-toggle-group" style="margin-bottom: 16px;">
            <button class="vf9-toggle-btn active" onclick="setHerioVersion('taxi', this)">Herio Green Chạy Dịch Vụ</button>
          </div>

          <div class="vf9-option-group-title">Hình thức sở hữu Pin:</div>
          <div class="vf9-toggle-group">
            <button class="vf9-toggle-btn active" onclick="setHerioBattery('thue', this)">Thuê Pin Ưu Đãi Dịch Vụ</button>
      ...
      <div class="vf9-config-price-bar">
        ...
        <div style="display: flex; gap: 12px;">
          ...
          <button class="vf-btn vf-btn-primary" onclick="alert('Đã gửi yêu cầu tư vấn xe Herio Green!')">ĐẶT MUA XE DỊCH VỤ</button>
        </div>
      </div>
...
<section class="vf9-section vf9-section-alt" id="tinh-nang">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Trang bị vượt trội phân khúc với màn hình giải trí cảm ứng, camera lùi và ghế da êm ái cho hành khách.</p>
    </div>
    ...
    <div class="vf9-grid-3">
      ...
      <div class="vf9-card" data-aos="fade-up" data-aos-delay="100">
        <img src="<?php echo esc_url($uploads_url . '/Herio-green-3-1536x864-1.jpg'); ?>" 
             alt="Khoang nội thất Herio Green" 
             class="vf9-card-img">
        <div class="vf9-card-body">
      ...
      <div class="vf9-card" data-aos="fade-up" data-aos-delay="200">
        <img src="<?php echo esc_url($uploads_url . '/Herio-green1-1536x864-1.jpg'); ?>" 
             alt="Sạc điện nhanh Herio Green" 
             class="vf9-card-img">
        <div class="vf9-card-body">
...
<section class="vf9-section" id="van-hanh">
  <div class="container">
    <div class="vf9-sec-head" data-aos="fade-up">
      ...
      <p class="vf9-sec-desc">Vận hành êm ái không tiếng ồn động cơ, gia tăng sự hài lòng điểm đánh giá 5 sao từ khách hàng.</p>
    </div>
        ...
        <div class="vf-calc-left">
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="lít">
              <input type="number" id="herio_fuel_consumption" class="vf-number-input" value="7.5" min="1" max="30" step="0.1" placeholder="7.5">
            </div>
          </div>
          ...
          <div class="vf-field-group">
            ...
            <div class="vf-input-unit" data-unit="km">
              <input type="number" id="herio_distance_month" class="vf-number-input" value="3500" min="100" max="10000" step="50" placeholder="3500">
            </div>
          </div>

          <p class="vf-hint">(*) Nhập số, dùng dấu chấm "." cho phần thập phân (không dùng dấu phân cách hàng nghìn). Ví dụ: 7.5 lít; 3500 km chạy taxi.</p>
        ...
        <div class="vf-calc-right">
          <div class="vf-result-header">
            ...
            <div class="vf-result-header-text">
              ...
              <p class="vf-result-placeholder" id="herio_result_placeholder">(*) Chưa có dữ liệu so sánh. Vui lòng nhập thông tin!</p>
            </div>
            <img src="<?php echo esc_url($uploads_url . '/cutout_herio.png'); ?>"
  ...
  <div class="container">
    ...
    <div class="vf9-specs-table-wrap" data-aos="fade-up">
      <table class="vf9-specs-table">
        ...
        <tr><td>Dung lượng pin khả dụng</td><td>37.23 kWh</td></tr>
        <tr><td>Quãng đường di chuyển (NEDC)</td><td>326 km / 1 lần sạc đầy</td></tr>
        <tr><td>Thời gian sạc nhanh (10-70%)</td><td>30 phút (Cổng DC)</td></tr>
      </table>
    </div>
